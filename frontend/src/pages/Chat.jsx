...
export default function Chat() {
    ...
    // We keep local loading for message processing, context has global loading for translations
    ...
    return (
        <SkeletonTheme baseColor="#1a1a1a" highlightColor="#2a2a2a">
            <div className="h-screen bg-[#030303] text-white font-sans flex flex-col relative overflow-hidden">
                                ...
                                >
                                    ...
                                    <div className="p-4 rounded-2xl bg-neutral-900/50 border border-white/10 flex items-center gap-2">
                                        ...
                                        <span className="text-xs text-neutral-500 font-medium ml-2 uppercase tracking-wider">
                                            {isLangLoading ? <Skeleton width={100} /> : t.loading}
                                        </span>
                                    </div>
                                </motion.div>
                            )}
